...
void ModifyPage::Load()
{
    ...
    std::cout << "2. Modify quadrilaterals\n";
    std::cout << "3. Modify triangles\n";
    std::cout << "4. Modify shapes by color\n";
    std::cout << "5. Modify shapes sorted by perimeter\n";
    std::cout << "6. Modify shapes sorted by name\n";
    std::cout << "0. Go back\n";
